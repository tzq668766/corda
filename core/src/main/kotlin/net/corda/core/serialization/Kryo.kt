...
fun createKryo(k: Kryo = Kryo()): Kryo {
    return k.apply {
        ...
        register<Array<StackTraceElement>>(read = { kryo, input -> emptyArray() }, write = { kryo, output, o -> })
...
inline fun <reified T : Any> Kryo.register(crossinline read: (Kryo, Input) -> T, crossinline write: (Kryo, Output, T) -> Unit) {
