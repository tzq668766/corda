 ...
 */
open class CashPaymentFlow(val amount: Amount<Issued<Currency>>, val recipient: Party.Full, progressTracker: ProgressTracker) : AbstractCashFlow(progressTracker) {
    constructor(amount: Amount<Issued<Currency>>, recipient: Party.Full) : this(amount, recipient, tracker())
