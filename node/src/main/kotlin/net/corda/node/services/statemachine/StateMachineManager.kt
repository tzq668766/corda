    ...
    private fun processIORequest(ioRequest: FlowIORequest) {
        ...
        if (ioRequest is SendRequest) {
            ...
            if (stx != null) {
                ...
                mutex.locked {
                    fibersWaitingForLedgerCommit[ioRequest.hash] += ioRequest.fiber as FlowStateMachineImpl<*>
                }
            }
        }
    }
