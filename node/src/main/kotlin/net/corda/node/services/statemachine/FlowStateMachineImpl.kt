...
class FlowStateMachineImpl<R>(override val id: StateMachineRunId,
    ...
    override fun waitForLedgerCommit(hash: SecureHash, sessionFlow: FlowLogic<*>): SignedTransaction {
        ...
        suspend(WaitForLedgerCommit(hash, sessionFlow.stateMachine))
        ...
        return stx ?: throw AssertionError("We were resumed after waiting for $hash but it wasn't found in our local storage")
    }
